...
class ScanWindowDataWidget(CollapsableWidget):
    def __init__(self, viewer: 'napari.viewer.Viewer', parent=None):
        ...
        self.label_type_entry = QLabel('ScanWindow')
        self.label_dtype = QLabel('DType:')
        ...
        self.label_images_acquired_entry = QLabel(str(layer.metadata['ct metadata']['images_acquired']))
        self.label_times = QLabel('Times:')
        self.label_times_entry = QLabel(str(layer.metadata['ct metadata']['times']))
        ...
        self.layout.addWidget(self.label_magnification, 3, 0)
        self.layout.addWidget(self.label_magnification_entry, 3, 1)
        self.layout.addWidget(self.label_angle, 4, 0)
        self.layout.addWidget(self.label_angle_entry, 4, 1)
        self.layout.addWidget(self.label_dosage, 5, 0)
        self.layout.addWidget(self.label_dosage_entry, 5, 1)
        self.layout.addWidget(self.label_images_acquired, 6, 0)
        self.layout.addWidget(self.label_images_acquired_entry, 6, 1)
